...
int main() {
  ...
  Shader fragment("./shader/coordinate1/frag.glsl", 1);
  ...
  delete vertices;
  // texture
  Texture texture1("./assert/container.jpg");
  Texture texture2("./assert/awesomeface.png");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      shaderProgram.set4Matrix("model", model);
